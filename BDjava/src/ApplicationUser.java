        ...
        System.out.println("Checking connection ... :");
		    ...
		    String idCompte;
				...
				if ( u.equals("1")) {
					...
					idCompte = String.valueOf(Math.abs(email.hashCode()));
					System.out.println("Votre ID de compte est : "+idCompte);
        ...
        // Resultat de la connexion
				...
				if (!rset.next()) {
					...
					do {
						...
						//Affichage des produits qui sont toujours disponibles
						...
						if (scannerEntry.nextLine().equals("1")) {
							...
							stmt = conn.prepareStatement("SELECT Idprod,Caracteristique,valeur FROM Caracteristiques WHERE Idprod = ? ");
